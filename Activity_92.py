...
def main():
    ...
    while not done:
        ...
        if pressed[pygame.K_a] or pressed[pygame.K_LEFT]: x -= 3
        if pressed[pygame.K_d] or pressed[pygame.K_RIGHT]: x += 3
        if pressed[pygame.K_w] or pressed[pygame.K_UP]: y -= 3
        if pressed[pygame.K_s] or pressed[pygame.K_DOWN]: y += 3
