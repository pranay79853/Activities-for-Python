...
# 4) Define a method `print_String(self)` to display the string in title case:

# a) Convert `self.str1` to title case using `.title()`.
...
# 7) Call the method `print_String()` using the object to print the title case string.